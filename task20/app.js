...
// Использую API https://fakestoreapi.com/docs
// вывести на страницу карточки товаров. Добавить Селект с категориями товаров. ПРи выборе какой-то категории, отображать только товары данной категории.
// Использовать Promise. Прописывать обработчики ошибок (catch)
